function Particle(t,s,h,i,o,a,n,d,c){
    ...
    this.type = a || "matter";
    this.name = n || "";
    this.color =  c !== undefined ? c : [255,255,255];
    this.age = 0;
    ...
    if (this.type === "dark") {
        ...
        this.radius=(55 * Math.random()) * Math.random(); // Radio Aleatorio
    ...
    // Normal matter/antimatter
        ...
        if (this.type === "neutron") {
            this.magnetosphereRadius = this.radius * 35;
            this.gravityInfluenceRadius = this.radius * 90; // Radio de influencia grande
