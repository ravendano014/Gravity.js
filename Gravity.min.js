            ...
            if (i !== j) {
                ...
                if (dist > 1e-5) {
                    ...
                    if (p1.type === "dark" && p2.type === "dark") {
                        ...
                        force = G * p2.mass / distSq * darkMatterInteractionFactor;
...
// Event listeners and other functions remain largely the same as in your original code
// ... (mouseDownListener, mouseMoveListener, mouseUpListener, mouseWheelListener, etc.)
