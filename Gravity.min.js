...
var newName = "New Particle", newType = "matter", newDensity = 1;
...
function mouseUpListener(t){
    ...
    if (!t.shiftKey && !shiftDown) {
        ...
        particleList.push(new Particle(newMass, worldStartX, worldStartY, (worldEndX - worldStartX), (worldEndY - worldStartY), newType, newName, newDensity, newColor));
